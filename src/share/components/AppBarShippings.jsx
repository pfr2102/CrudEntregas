...
const pages = ['Shippings', 'Prices', 'Payments', 'Orders'];
...
function ResponsiveAppBar() {
    ...
    useEffect(() => {
        switch (myPages) {
            case "":
                ...
                break;
            case "SHIPPINGS":
                navigate("/shippings");//Al cambiar tambien cambiar en NaviRoutesShippings.jsx
                break;
            case "PRICES":
                navigate("/prices");
                break;
  ...
  return (
    //Cambiar aqui entre static y fixed en caso de ser necesario para el ajuste del appbar aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
