  ...
  const EstatusTable = ({}) => {
    ...
    useEffect(() => {
      const handleRowClick = (index) => {
        const row = EstatusData[index];
        //Aqui es donde se decide que hacer con la data que regresa el clic en la fila
        console.log("<<ID DEL DOCUMENTO SELECCIONADO>>:", row.IdTipoEstatusOK); //row.id_domicilioOK devuelve solo el id, debe funcionar con todo lo demas
    ...
    return (
        <Box>
          ...
          <Dialog open={EstatusShowModal}>
            <EstatusModal
              EstatusShowModal={EstatusShowModal}
              setEstatusShowModal={setEstatusShowModal}
