  ...
  const ProductosTable = ({}) => {
    ...
    useEffect(() => {
      const handleRowClick = (index) => {
        const row = ProductosData[index];
        //Aqui es donde se decide que hacer con la data que regresa el clic en la fila
        console.log("<<ID DEL DOCUMENTO SELECCIONADO>>:", row.IdProdServOK); //row.id_domicilioOK devuelve solo el id, debe funcionar con todo lo demas
