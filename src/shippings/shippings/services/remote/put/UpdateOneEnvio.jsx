...
export function UpdateOneEnvio(EnvioSubdocument, idInstitutoOK, idNegocioOK, idEntregaOK, idDomicilioOK) {
    ...
    return new Promise((resolve, reject) => {
        axios.put(`${import.meta.env.VITE_SHIPPINGS_URL}/subdocumentE/?IdInstitutoOK=${idInstitutoOK}&IdNegocioOK=${idNegocioOK}&IdEntregaOK=${idEntregaOK}&IdDomicilioOK=${idDomicilioOK}`, EnvioSubdocument)
            .then((response) => {
