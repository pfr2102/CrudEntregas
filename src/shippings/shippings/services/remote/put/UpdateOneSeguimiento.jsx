...
export function UpdateOneSeguimiento(Seguimiento, idInstitutoOK, idNegocioOK, idEntregaOK, idDomicilio, Ubicacion) {
    ...
    return new Promise((resolve, reject) => {
        axios.put(`${import.meta.env.VITE_SHIPPINGS_URL}/subdocumentESe/?IdInstitutoOK=${idInstitutoOK}&IdNegocioOK=${idNegocioOK}&IdEntregaOK=${idEntregaOK}&Ubicacion=${Ubicacion}&IdDomicilioOK=${idDomicilio}`, Seguimiento)
            .then((response) => {
